...
/**
 * Update the buffer to read from `fd`.
 *
 * @param buf  parser input buffer
 * @param fd  file descriptor
 * @returns an xmlParserErrors code.
 */
xmlParserErrors xmlInputFromFd(xmlParserInputBuffer* buf, int fd) {
	xmlFdIOCtxt* fdctxt;
	int          copy;
 ...
 * @returns an xmlParserErrors code.
 */
xmlParserErrors xmlParserInputBufferCreateUrl(const char* URI, xmlCharEncoding enc, xmlParserInputBuffer** out) {
...
xmlParserInputBuffer* __xmlParserInputBufferCreateFilename(const char* URI, xmlCharEncoding enc) {
	...
	xmlParserInputBufferCreateUrl(URI, enc, &ret);
	return (ret);
}
...
xmlParserInputBuffer* xmlParserInputBufferCreateFilename(const char* URI, xmlCharEncoding enc) {
	...
	code = xmlParserInputBufferCreateUrl(URI, enc, &ret);
