...
#ifdef LIBXML_VALID_ENABLED
	if ((ctxt->validate) && (ctxt->standalone == 1) && (special & XML_SPECIAL_EXTERNAL)
...
static int xmlCtxtSetOptionsInternal(xmlParserCtxtPtr ctxt, int options, int keepMask) {
	...
	allMask = XML_PARSE_RECOVER | XML_PARSE_NOENT | XML_PARSE_DTDLOAD | XML_PARSE_DTDATTR
	        ...
	        | XML_PARSE_NOBLANKS |
	          ...
	          XML_PARSE_SAX1 |
#endif
	          XML_PARSE_NODICT | XML_PARSE_NSCLEAN | XML_PARSE_NOCDATA | XML_PARSE_COMPACT
	        | XML_PARSE_OLD10 | XML_PARSE_HUGE | XML_PARSE_OLDSAX | XML_PARSE_IGNORE_ENC
	        | XML_PARSE_BIG_LINES | XML_PARSE_NO_XXE | XML_PARSE_NO_SYS_CATALOG
...
int xmlCtxtUseOptions(xmlParserCtxt* ctxt, int options) {
	 ...
	 */
	keepMask = XML_PARSE_NOERROR | XML_PARSE_NOWARNING | XML_PARSE_NSCLEAN | XML_PARSE_NOCDATA
